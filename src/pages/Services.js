        ...
        <div className="container">
          <div className="row gy-4">
            ...
            <div className="col-md-6 my-container">
              <div className="card p-3 mb-2" style={{ height: "210px", backgroundColor: "#F0F0F0" }}>
                ...
                <div className="my-overlay" style={{ paddingTop: "10px" }}>
                  <div className="my-text">
                    <p style={{ textAlign: "justify", color: "white", padding: "4px 4px" }}>

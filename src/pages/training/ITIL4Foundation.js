          ...
          <div className="section-header">
            ...
            <div className="col-lg-12 content" style={{ textAlign: "justify" }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: "50% 50%" }}>
                  <div>
                    <ul style={{ listStyle: "none" }}>
                      ...
                      <li><i style={{ fontSize: "20px", paddingRight: "15px", color: "#50d8af", fontWeight: "400", }} className="bi bi-check-circle"></i>
                        ITIL® 4 Foundation Tips & Trick
                      </li>
                      <li><i style={{ fontSize: "20px", paddingRight: "15px", color: "#50d8af", fontWeight: "400", }} className="bi bi-check-circle"></i>
                        ITIL® 4 Foundation Simulation Exam
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div>
                ...
                <p>
                  ITIL 4 Foundation Approved Trainer and IT Management Professional with over 12 years of experience in industry and holding valid ITIL 4 Managing Professional (MP)
                </p>
                <div style={{ display: 'grid', gridTemplateColumns: "50% 50%" }}>
                  <div>
                    <ul style={{ listStyle: "none" }}>
        ...
        <div className="container">
          <div className="section-header">
            <div className="row gy-4">
              ...
              <h4 style={{ fontFamily: "Poppins", fontWeight: "900", color: "#54595F" }}>Our ITIL® 4 Products</h4>
              <div className="row">
                <div class="col-md-6">
                  <div class="card mb-3 h-100">
                    ...
                    <div class="card-body" style={{ textAlign: "justify", background: "#F7F7F7" }}>
                      <ul style={{ listStyle: "none" }}>
                        ...
                        <li style={{ borderBottom: "2px dotted #54595F" }}><i style={{ fontSize: "20px", paddingRight: "15px", color: "#50d8af", fontWeight: "400", }} className="bi bi-check-circle"></i>
                          <span className="list-name">ITIL® 4 Foundation Simulation </span>
                        </li>
                      </ul>
                    </div>
                  </div>
...
export default ITIL4Foundation